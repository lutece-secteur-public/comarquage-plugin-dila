...
INSERT INTO core_admin_right (id_right, name, level_right, admin_url, description, is_updatable, plugin_name, id_feature_group, icon_url, documentation_url, id_order)
 VALUES ('DILA_LOCAL_CARD_MANAGEMENT', 'dila.adminFeature.fichelocale.name', 2, 'jsp/admin/plugins/dila/ManageLocalCard.jsp', 'dila.adminFeature.fichelocale.description', 0, 'dila', NULL, 'images/admin/skin/plugins/dila/manage_local_card.png', 'jsp/admin/documentation/AdminDocumentation.jsp?doc=dila', 1);
